...
EMAIL_EXPEDITEUR = "ibrahimmilanho6803@gmail.com"
MOT_DE_PASSE_APP = "tfre srqw mbxt xyan"
...
def envoyer_licence(email_destinataire, cle_licence, plan):
    ...
    msg['Subject'] = "Votre accès Triple Elite VIP"
    msg['X-Priority'] = '3'
...
<p>Bonjour,</p>
<p>Merci pour votre abonnement ! Voici vos clé d'accès :</p>
<div style="background: #0d1137; padding: 15px; border-radius: 5px; margin: 20px 0;">
<p><strong>Email :</strong> {email_destinataire}</p>
<p><strong>Clé d'accès :</strong> <span style="color: #ffd700;">{cle_licence}</span></p>
<p><strong>Plan :</strong> {plan}</p>
</div>
<p>Connectez-vous sur : <a href="http://localhost:5000/login" style="color: #ffd700;">Dashboard VIP</a></p>
